  ...
  <div class="container">
 	...
 	<div class="content">
	 	<header>
	 		...
	 		<div class="like"><img class="img-logo" src="~/assets/img/like/like5.svg" alt="Made by you" /></div>
	 	</header>
	 	...
	 	<div class="content-made">
		 	...
		 	<div class="content-made-right etape4">
				...
				<div class="preview-nav valid" @mouseleave='hideActiveValidT'>
					<div @mouseover='displayActiveValidT'  class="type-bt">Imprimer</div>
  ...
  ,
   methods: {
	...
	loadSvg: function(file) {
		document.querySelector('.preview-element').innerHTML = this.parametres.id_etape_4;

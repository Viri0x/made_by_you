...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(43)["URL"]))
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/editFile.vue?vue&type=template&id=7e263306&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"form-bloc form-bloc-list mt-9\">","</div>",[_vm._ssrNode("<div class=\"col w-full\">","</div>",[_vm._ssrNode("<div class=\"col-content\">","</div>",[_vm._ssrNode("<label for=\"AddFile\" id=\"LAddFile\" class=\"mb-3 border-b border-mainColor cursor-pointer\"><div class=\"pb-2\">Fichiers son</div> <div class=\"flex-1 text-right flex justify-end add highlight\"><svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\" class=\"bi\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M12 4v16m8-8H4\"></path></svg></div></label> <div"+(_vm._ssrStyle(null,null, { display: (_vm.isShowLoadingFiles) ? '' : 'none' }))+">Chargement des fichiers...</div><div"+(_vm._ssrStyle(null,null, { display: (_vm.isShowNoResultFiles) ? '' : 'none' }))+">Aucun fichier</div> "),_c('draggable',{staticClass:"sound-grid w-full",attrs:{"list":_vm.files,"tag":"div","draggable":".item"},on:{"end":_vm.onEndPosition}},_vm._l((_vm.files),function(file,indexFile){return _c('div',{staticClass:"relative item cursor-pointer"},[_c('div',{staticClass:"soundPlayer",attrs:{"id":'S_' + indexFile}},[_c('div',{staticClass:"progress-play"},[_c('div',{staticClass:"progress-play-val"})]),_vm._v(" "),_c('div',{staticClass:"content-play"},[_c('div',{staticClass:"player isLoading",on:{"click":function($event){return _vm.playSound('/upload/' + file.fichier,'S_' + indexFile, indexFile)}}},[_c('img',{attrs:{"src":"/img/play.svg","alt":"Play"}})]),_vm._v(" "),_c('div',{on:{"click":function($event){_vm.displayFile(file.id_file);_vm.hideErreur();}}},[_vm._v(_vm._s(file.titre))]),_vm._v(" "),_c('div',{staticClass:"duration"},[_vm._v("..."+_vm._s(_vm.loadSound('/upload/' + file.fichier,'S_' + indexFile, indexFile)))])])])])}),0)],2)])]),_vm._ssrNode(" <div id=\"defaultModalFile\" tabindex=\"1\" class=\"modalZone hidden overflow-y-auto overflow-x-hidden bg-mainBg/50 flex fixed right-0 left-0 top-4 z-50 justify-center items-center md:h-full md:inset-0\"><div class=\"relative px-6 w-full max-w-2xl h-full md:h-auto\"><div class=\"relative bg-mainBg p-6 border border-activeColor\"><div class=\"flex justify-between items-start border-b border-mainColor\"><h1>Fichier</h1> <div data-modal-toggle=\"defaultModalFile\" class=\"bg-transparent ml-auto inline-flex items-center highlight\"><svg fill=\"currentColor\" viewBox=\"0 0 20 20\" xmlns=\"http://www.w3.org/2000/svg\" class=\"big cursor-pointer\"><path fill-rule=\"evenodd\" d=\"M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z\" clip-rule=\"evenodd\"></path></svg></div></div> <div><div class=\"form-container w-full border-0 p-0\"><form method=\"post\" autocomplete=\"off\"><div class=\"form-bloc mt-9\"><div class=\"col w-full\"><div class=\"col-content\"><div><div"+(_vm._ssrClass("justify-between align-center",_vm.flexIsFile))+"><div class=\"previewFileUpload pb-1 flex items-center  justify-center\"><div class=\"text-sm\">"+(_vm._s(_vm.previewFile))+"</div></div></div> <label class=\"uploadZone-file bt-upload required_field\"><span class=\"leading-normal\">choisir un mp3</span> <input type=\"file\" id=\"file_media\""+(_vm._ssrAttr("accept",_vm.accept_file))+" class=\"hidden\"></label> <div class=\"progress progress-media hidden\"><div class=\"progress-title-media\">"+_vm._ssrEscape(_vm._s(_vm.uploadPercentageFile)+"%")+"</div> <div class=\"progress-bar-media\""+(_vm._ssrStyle(null,{ width: _vm.uploadPercentageFile + '%' }, null))+"></div></div></div></div></div></div> <div class=\"form-action\"><div><button type=\"button\">Annuler</button></div> <div"+(_vm._ssrStyle(null,null, { display: (_vm.id_file != 0) ? '' : 'none' }))+"><button type=\"button\" class=\"bt-delete\">Supprimer</button></div></div></form></div></div></div></div></div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/editFile.vue?vue&type=template&id=7e263306&
...
var external_vuedraggable_ = __webpack_require__(41);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/editFile.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var editFilevue_type_script_lang_js_ = ({
  name: 'edit-media',
  layout: 'edit',
  middleware: 'auth',
  components: {
  ...
  mounted() {
    this.getFiles();
    Tone = __webpack_require__(45);
    playerSound = new Tone.Player().toDestination(); //this.loadSound('',1,1)
  },
  ...
  methods: {
    getFiles: function () {
      external_axios_default.a.get(this.url_server + "/getFiles?id_playlist=" + this.id_parent).then(response => {
    ...
    getFile: function () {
      external_axios_default.a.get(this.url_server + "/getFile?id_file=" + this.id_file).then(response => {
    ...
    delFile: function () {
      external_axios_default.a.get(this.url_server + "/delFile?id_file=" + this.id_file).then(response => {
        this.displayFile();
        this.getFiles();
      }).catch(error => {
        this.id_file = 0;
    ...
    submitFileForm() {
      ...
      if (checkRequiredModal()) {
        ...
        external_axios_default.a.post(this.url_server + "/addFile", data).then(response => {
    ...
    submitMedia() {
      ...
      external_axios_default.a.post(this.url_server + '/uploadFile', formData, {
        ...
        this.submitFileForm(); //this.getPreviewFile();
      }).catch(err => {
    ...
    getPreviewFile: function () {
      document.querySelectorAll(".progress-title-media")[0].innerHTML = ''; //document.querySelectorAll(".progress-stop-media")[0].classList.remove('hidden')
    ...
    onEndPosition() {
      ...
      external_axios_default.a.post(this.url_server + "/updateFilePosition", data).then(response => {}).catch(error => displayErreur("error updating positions"));
    },
    ...
    pauseSound(id) {
      ...
      document.querySelector('#' + id + ' .player img').setAttribute("src", "/img/play.svg"); //Tone.Transport.stop();
    ...
    playSoundProgress(id) {
      if (this.isPlayingSound != -1) {
        ...
        }.bind(this), 200); //setInterval(function () { if (this.isPlayingSound != -1) this.playSoundProgress(id) }.bind(this), 100);     
      } else {
        console.log("OUT");
    ...
    playSoundOld(file, id, index) {
      ...
      playerSound = new Tone.Player(file, () => {
        ...
        playerSound.start(); // seek to the offset in 1 second from now
        //player.seek(0.4, "+1");
      }).toDestination();
    },
...
// CONCATENATED MODULE: ./components/editFile.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_editFilevue_type_script_lang_js_ = (editFilevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./components/editFile.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  components_editFilevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var editFile = __webpack_exports__["default"] = (component.exports);
